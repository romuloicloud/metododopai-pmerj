...
async function insertExam() {
    try {
        const jsonPath = path.resolve(__dirname, '../extracted_questions_2019.json');
        ...
        console.log(`🚀 Iniciando inserção da prova 2019 (${questions.length} questões)...`);
        ...
        const questionsToInsert = questions.map(q => ({
            ...
            // difficulty column skipped intentionally to avoid migration block, data remains in JSON
        }));
